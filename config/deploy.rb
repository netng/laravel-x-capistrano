...
set :repo_url, "git@github.com:netng/laravel-x-capistrano.git"
...
append :linked_dirs, "vendor", "storage/app", "storage/framework/cache", "storage/framework/sessions", "storage/framework/views", "storage/logs"
